...
oc -n cityapp get configmap | grep -q cityapp-secretless-cm && oc -n cityapp delete configmap cityapp-secretless-cm
oc -n cityapp create configmap cityapp-secretless-cm --from-file=yaml/cityapp-secretless-cm.yaml
...
#Deploy pod
oc adm policy add-scc-to-user anyuid system:serviceaccount:cityapp:cityapp-secretless
